...
#define NUM_LEDS 27
#define NUM_STRINGS 16 //15 visible strings and 11 strings out-of-vision
#define DATA_PIN 1
...
SimplePatternList gPatterns = {sinelon, shine1a, lowProfileGlittering, shine2, shine3, lowProfileRainbow, shine1b, shine2ex};
