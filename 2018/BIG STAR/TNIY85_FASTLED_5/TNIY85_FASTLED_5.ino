...
SimplePatternList gPatterns = {shine2b, shine1a, shine2, shine3, rainbow, rainbowWithGlitter, shine3ex, shine1b, shine2ex};
...
uint8_t mainColor[11] = {160, 64, 0, 192, 32, 0, 128, 96, 0, 160, 96};
