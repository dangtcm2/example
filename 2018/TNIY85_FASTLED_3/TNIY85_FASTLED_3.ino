...
SimplePatternList gPatterns = {rainbowSweep, shine1a, shine2, shine3, lowProfileGlittering,  lowProfileRainbow, confetti, lowProfileSinelon, juggleMonochrome};
...
uint8_t gCurrentPatternNumber = random(1, 3); // Index number of which pattern is current
