...
void shine2()
{
  ...
  if (count >= 0) {
    for (int i = count; i >= 0; i--) {
      if ((c == 0 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 235, 90);
      if ((c == 1 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 235, 255);
      if ((c == 2 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 235, 255);
      if ((c == 3 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 235, 90);
      if ((c > 3) && (i <= NUM_LEDS)) leds[i] = CRGB(0, 0, 0);
      c++;
      if (c >= 12) c = 0;
    }
  }
...
void shine2c()
{
  ...
  if (count >= 0) {
    for (int i = count; i >= 0; i--) {
      if ((c == 0 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 255, 255);
      if ((c == 1 ) && (i <= NUM_LEDS)) leds[i] = CHSV(h, 255, 255);
      if ((c > 1 ) && (i <= NUM_LEDS)) leds[i] = CRGB(0, 0, 0);
      c++;
      if (c >= 6) {
        c = 0;
        h += 30;
...
void shine2d()
{
  ...
  if (count >= 0) {
    for (int i = count; i >= 0; i--) {
      if ((c == 0 ) && (i <= NUM_LEDS)) leds[i] = CHSV(0, 0, 255);
      if ((c > 0 ) && (i <= NUM_LEDS)) leds[i] = CHSV(gHue, 255, 255);
      c++;
      if (c >= 5)        c = 0;
    }
  }
...
void shine2e()
{
  ...
  if (count >= 0) {
    for (int i = count; i >= 0; i--) {
      if ((c <= 2 ) && (i <= NUM_LEDS)) leds[i] = CHSV(0, 0, 255);
...
void shine3()
{
  ...
  if (count >= 0) {
    for (int i = count; i >= 0; i--) {
      if ((c == 0) && (i <= NUM_LEDS)) leds[i] = CHSV(0, 0, 255);
      if ((c == 1) && (i <= NUM_LEDS)) leds[i] = CHSV(gHue, 255, 255);
      if ((c == 2) && (i <= NUM_LEDS)) leds[i] = CHSV(gHue, 255, 240);
      if ((c == 3) && (i <= NUM_LEDS)) leds[i] = CHSV(gHue, 255, 120);
      if ((c == 4) && (i <= NUM_LEDS)) leds[i] = CHSV(gHue, 255, 60);
